    ...
    <header className="vi-dash-header">
      ...
      <div className="vi-dash-header__top">
        ...
        <div className="vi-dash-header__search" role="search">
          <VictorIcon name="search" size={15} aria-hidden style={{ color: 'var(--t3)' }} />
          <input
            type="text"
            value={search}
      ...
      <div className="vi-dash-header__bottom">
        ...
        <div className="vi-dash-header__meta">
          ...
          >
            <svg width={14} height={14} viewBox="0 0 24 24" stroke="currentColor" fill="none" strokeWidth={2} strokeLinecap="butt" strokeLinejoin="miter" aria-hidden><rect x="3" y="5" width="18" height="16"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="3" x2="8" y2="7"/><line x1="16" y1="3" x2="16" y2="7"/></svg>
            <span>Filter date</span>
            <VictorIcon name="chevron" size={14} aria-hidden style={{ opacity: 0.6 }} />
          </button>
        </div>
      </div>
